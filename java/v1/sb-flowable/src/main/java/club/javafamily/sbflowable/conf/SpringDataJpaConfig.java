...
@EnableJpaRepositories(
   basePackages = {"club.javafamily.sbflowable.dao"},
   entityManagerFactoryRef = "entityManagerFactory",
   transactionManagerRef = "transactionManager"
)
public class SpringDataJpaConfig {

   @Value("${spring.jpa.hibernate.primary-dialect:org.hibernate.dialect.PostgreSQLDialect}")
   private String primaryDialect;

   @Value("${spring.jpa.primary.database:POSTGRESQL}")
      ...
      EntityManagerFactoryBuilder builder)
   {
      ...
      return builder
         ...
         .packages("club.javafamily.sbflowable.domain") //设置实体类所在位置
