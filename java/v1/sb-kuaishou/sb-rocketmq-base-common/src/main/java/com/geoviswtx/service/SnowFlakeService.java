...
import com.geoviswtx.common.lang.IdUtil;
import com.geoviswtx.common.lang.Snowflake;
...
public class SnowFlakeService implements ApplicationContextAware {
   ...
   @Value("${geoviswtx.snowflake.maxDcId:31}")
   private Long maxDcId;

   @Value("${geoviswtx.snowflake.maxWorkerId:31}")
