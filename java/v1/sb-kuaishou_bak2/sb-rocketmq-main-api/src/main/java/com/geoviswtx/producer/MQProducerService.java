...
public class MQProducerService {
    ...
    public void sendWithTag(DefaultMessage msg, String tag) {
    ...
    public SendResult sendMsg(String msgBody, String tag) {
        ...
        log.info("【sendMsg】, tag:{}, sendResult={}", tag, JSONObject.toJSONString(sendResult));
        return sendResult;
    }
     ...
     */
    public SendResult sendTagMsg(DefaultMessage msgBody) {
