...
class CmadaasDataCenterApplicationTests {
   ...
   void testQuery() {
      ...
      params.put("elements", "Station_Id_C,Datetime,UPDATE_TIME,TEM_Max,TEM_Min") ;//检索要素：站号、站名、小时降水、气压、相对湿度、能见度、2分钟平均风速、2分钟风向
      params.put("timeRange", "(20100601000000,20200601010000]") ; //检索时间
      //可选参数
      params.put("orderby", "Station_ID_C:ASC") ; //排序：按照站号从小到大
      params.put("staLevels", "011,012") ; //排序：按照站号从小到大
      params.put("limitCnt", "10") ; //返回最多记录数：100
      /* 2.4 返回对象 */
