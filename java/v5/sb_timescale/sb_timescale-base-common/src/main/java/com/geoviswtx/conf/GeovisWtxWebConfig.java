...
public class GeovisWtxWebConfig implements WebMvcConfigurer {
   ...
   private final GeoVisWtxInterceptor geovisWtxInterceptor;
   private final ObjectMapper objectMapper;

   public GeovisWtxWebConfig(LogInterceptor logInterceptor,
                             GeoVisWtxInterceptor geovisWtxInterceptor,
                             ObjectMapper objectMapper)
   {
      this.logInterceptor = logInterceptor;
      this.geovisWtxInterceptor = geovisWtxInterceptor;
   ...
   public void addInterceptors(InterceptorRegistry registry) {
      ...
      registry.addInterceptor(geovisWtxInterceptor)
         .addPathPatterns("/**")
